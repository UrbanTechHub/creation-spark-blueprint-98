...
export const Dashboard = ({ onLogout }: DashboardProps) => {
  ...
  const [currentBalance, setCurrentBalance] = useState(752110.19);
  ...
  const [transactions] = useState([
    ...
    },
    {
      id: 3,
      type: 'transfer',
      description: 'Wire Transfer to Maria Garcia',
      amount: -1200.00,
      date: '2025-01-09',
      status: 'completed'
    }
  ...
  return (
    <div className="min-h-screen bg-gray-50/95 pb-20 relative">
      ...
      <div className="bg-white/95 px-4 py-6 border-b backdrop-blur-sm">
        ...
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Good morning Diola!</h1>
        ...
        <div className="bg-white border-l border-r border-gray-200 px-4 py-4 rounded-b-lg">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="text-right">
              <div className="text-2xl font-bold text-gray-900">$122.15</div>
      ...
      <div className="px-4 py-6 bg-white/95 mt-4 backdrop-blur-sm">
        ...
        <div className="space-y-3">
          {transactions.map((transaction) => (
            <div key={transaction.id} className="flex items-center justify-between p-3 bg-white rounded-lg border border-gray-100">
              <div className="flex items-center space-x-3">
